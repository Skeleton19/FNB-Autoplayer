...
local Keys = {
    ...
    [5] = { D = "L2" , F = "L1", Space = "Space", J = "R1", K = "R2", Left = "Left", Down = "Down", Up = "Up", Right = "Right" },
...
ExtrasFolder:AddButton({Name = "TP To Rich Noob Boss", Callback = function() game:GetService'TeleportService':Teleport(12849973047, Client) end})
